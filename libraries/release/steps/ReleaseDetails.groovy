class ReleaseDetails{ 
    ...
    void run() {
        ...
        def lastHyphenIndex = appNameVersion.lastIndexOf('-')
        def appName = appNameVersion(0, lastHyphenIndex)
        def version = appNameVersion(lastHyphenIndex + 1) 
        
        jenkinsSteps.println "applciationName = ${appName}"
